...
# Charger le dataset (vérifiez que le dossier 'data' existe bien dans C:\Users\HP\sensante)
df = pd.read_csv("data/patients_dakar.csv")

# Verifier les dimensions
print(f"Dataset : {df.shape[0]} patients, {df.shape[1]} colonnes")

# Utilisation de \n sans espace pour les sauts de ligne
...
# On retire les espaces dans les noms de colonnes pour éviter les erreurs
...
# # Ajuster automatiquement les marges pour ne pas couper les labels
# plt.tight_layout()
...
# Charger le modele DEPUIS LE FICHIER
