...
// Corriger les icones Leaflet (bug webpack) [cite: 117]
...
// Calculer la distance entre 2 points GPS (km) [cite: 249]
function calculerDistance(lat1, lon1, lat2, lon2) {
  const R = 6371; // rayon de la Terre en km [cite: 142]
...
function Carte() {
  ...
  const DAKAR = [14.6928, -17.4467]; // [cite: 163]

  // Charger les arrets depuis Flask [cite: 244]
  useEffect(() => {
  ...
  // Trouver l'arret le plus proche [cite: 248]
  useEffect(() => {
